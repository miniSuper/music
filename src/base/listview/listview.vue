<template>
  <scroll @scroll="scroll" :data="data" :listen-scroll="listenScroll" :probe-type="probeType" class="listview" ref="listview">
    <ul>
      <li v-for="group in data" class="list-group" :key="group.index" ref="listGroup">
        ...
        <ul>
          <li @click="selectItem(item)" v-for="item in group.items" :key="item.index" class="list-group-item">
            <img class="avatar" v-if="item.avatar" v-lazy="item.avatar">
